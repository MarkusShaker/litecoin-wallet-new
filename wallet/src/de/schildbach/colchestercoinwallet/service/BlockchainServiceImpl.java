...
package de.schildbach.colchestercoinwallet.service;
...
import com.google.colchestercoin.discovery.SeedPeers;
import com.google.colchestercoin.script.Script;
import de.schildbach.colchestercoinwallet.*;
import de.schildbach.colchestercoinwallet.util.ThrottlingWalletChangeListener;
...
import com.google.colchestercoin.discovery.DnsDiscovery;
import com.google.colchestercoin.discovery.PeerDiscovery;
import com.google.colchestercoin.discovery.PeerDiscoveryException;
import com.google.colchestercoin.store.BlockStore;
import com.google.colchestercoin.store.BlockStoreException;
import com.google.colchestercoin.store.SPVBlockStore;

import de.schildbach.colchestercoinwallet.ui.WalletActivity;
	...
	private final BroadcastReceiver connectivityReceiver = new BroadcastReceiver()
	{
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				{
					final String message = "litecoinwallet/blockchain out of sync: " + walletLastBlockSeenHeight + "/" + bestChainHeight;
					log.error(message);
