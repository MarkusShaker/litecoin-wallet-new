...
package de.schildbach.colchestercoinwallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Bitcoin litecoinwallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=de.schildbach.litecoinwallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://code.google.com/p/bitcoin-litecoinwallet/downloads/list"));
